  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-12">
          ...
          >
            <div className="grid grid-cols-1 gap-6">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:mindra.services@gmail.com"
                        className="text-zenSage hover:underline"
                      >
                        mindra.services@gmail.com
                      </a>
                    </div>
                  </div>
                </CardContent>
              ...
              <div className="grid grid-cols-2 gap-4">
                <a
                  href="https://x.com/ahmedsamy__74?s=21"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/ahmed.adel.5/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex items-center justify-center gap-2"
                >
                ...
                <a
                  href="https://www.facebook.com/ahmed.shafiq.616210"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex items-center justify-center gap-2"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/ahmed-samy-289090263/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex items-center justify-center gap-2"
                >
        ...
        >
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3454.388823071722!2d31.472148776174116!3d30.025701019457582!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x145823d86664124b%3A0x25df8c74a982e7de!2sSouth%20teseen!5e0!3m2!1sen!2seg!4v1747316101911!5m2!1sen!2seg"
